...
//go:generate minimock -i github.com/BruteMors/marketplace-service/loms/internal/service/order.Repository -o repository_mock.go -n RepositoryMock -p mock
...
type RepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, order ordermodels.NewOrder) (orderID int64, err error)
	inspectFuncCreate   func(ctx context.Context, order ordermodels.NewOrder)
	afterCreateCounter  uint64
	beforeCreateCounter uint64
	CreateMock          mRepositoryMockCreate

	funcGetByID          func(ctx context.Context, orderID int64) (order ordermodels.Order, err error)
	inspectFuncGetByID   func(ctx context.Context, orderID int64)
	afterGetByIDCounter  uint64
	beforeGetByIDCounter uint64
	GetByIDMock          mRepositoryMockGetByID

	funcSetStatus          func(ctx context.Context, orderID int64, status ordermodels.Status) (err error)
	inspectFuncSetStatus   func(ctx context.Context, orderID int64, status ordermodels.Status)
...
func (mmCreate *mRepositoryMockCreate) Expect(ctx context.Context, order ordermodels.NewOrder) *mRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &RepositoryMockCreateParams{ctx, order}
...
// ExpectOrderParam2 sets up expected param order for Repository.Create
func (mmCreate *mRepositoryMockCreate) ExpectOrderParam2(order ordermodels.NewOrder) *mRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("RepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mRepositoryMockCreate) Inspect(f func(ctx context.Context, order ordermodels.NewOrder)) *mRepositoryMockCreate {
...
func (mmCreate *mRepositoryMockCreate) Return(orderID int64, err error) *RepositoryMock {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("RepositoryMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.results = &RepositoryMockCreateResults{orderID, err}
	return mmCreate.mock
}

// Set uses given function f to mock the Repository.Create method
func (mmCreate *mRepositoryMockCreate) Set(f func(ctx context.Context, order ordermodels.NewOrder) (orderID int64, err error)) *RepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mRepositoryMockCreate) When(ctx context.Context, order ordermodels.NewOrder) *RepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("RepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &RepositoryMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &RepositoryMockCreateParams{ctx, order},
	}
...
func (e *RepositoryMockCreateExpectation) Then(orderID int64, err error) *RepositoryMock {
	e.results = &RepositoryMockCreateResults{orderID, err}
	return e.mock
}
...
func (mmCreate *RepositoryMock) Create(ctx context.Context, order ordermodels.NewOrder) (orderID int64, err error) {
	...
	mm_params := RepositoryMockCreateParams{ctx, order}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockCreateParams{ctx, order}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCreate.t.Errorf("RepositoryMock.Create got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.order != nil && !minimock.Equal(*mm_want_ptrs.order, mm_got.order) {
				mmCreate.t.Errorf("RepositoryMock.Create got unexpected parameter order, want: %#v, got: %#v%s\n", *mm_want_ptrs.order, mm_got.order, minimock.Diff(*mm_want_ptrs.order, mm_got.order))
			}
	...
	mmCreate.t.Fatalf("Unexpected call to RepositoryMock.Create. %v %v", ctx, order)
	return
}
...
func (m *RepositoryMock) MinimockCreateInspect() {
	...
	if !m.CreateMock.invocationsDone() && afterCreateCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.Create but found %d calls",
...
func (mmGetByID *mRepositoryMockGetByID) Return(order ordermodels.Order, err error) *RepositoryMock {
	if mmGetByID.mock.funcGetByID != nil {
		mmGetByID.mock.t.Fatalf("RepositoryMock.GetByID mock is already set by Set")
	}
	...
	mmGetByID.defaultExpectation.results = &RepositoryMockGetByIDResults{order, err}
	return mmGetByID.mock
}

// Set uses given function f to mock the Repository.GetByID method
func (mmGetByID *mRepositoryMockGetByID) Set(f func(ctx context.Context, orderID int64) (order ordermodels.Order, err error)) *RepositoryMock {
	if mmGetByID.defaultExpectation != nil {
...
func (e *RepositoryMockGetByIDExpectation) Then(order ordermodels.Order, err error) *RepositoryMock {
	e.results = &RepositoryMockGetByIDResults{order, err}
	return e.mock
}
...
func (mmGetByID *RepositoryMock) GetByID(ctx context.Context, orderID int64) (order ordermodels.Order, err error) {
	...
	for _, e := range mmGetByID.GetByIDMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.order, e.results.err
		}
	}
	...
	if mmGetByID.GetByIDMock.defaultExpectation != nil {
		...
		return (*mm_results).order, (*mm_results).err
	}
...
func (mmSetStatus *mRepositoryMockSetStatus) Expect(ctx context.Context, orderID int64, status ordermodels.Status) *mRepositoryMockSetStatus {
...
func (mmSetStatus *mRepositoryMockSetStatus) ExpectStatusParam3(status ordermodels.Status) *mRepositoryMockSetStatus {
	if mmSetStatus.mock.funcSetStatus != nil {
		mmSetStatus.mock.t.Fatalf("RepositoryMock.SetStatus mock is already set by Set")
	}
...
func (mmSetStatus *mRepositoryMockSetStatus) Inspect(f func(ctx context.Context, orderID int64, status ordermodels.Status)) *mRepositoryMockSetStatus {
...
func (mmSetStatus *mRepositoryMockSetStatus) Set(f func(ctx context.Context, orderID int64, status ordermodels.Status) (err error)) *RepositoryMock {
	if mmSetStatus.defaultExpectation != nil {
...
// Then helper
func (mmSetStatus *mRepositoryMockSetStatus) When(ctx context.Context, orderID int64, status ordermodels.Status) *RepositoryMockSetStatusExpectation {
	if mmSetStatus.mock.funcSetStatus != nil {
		mmSetStatus.mock.t.Fatalf("RepositoryMock.SetStatus mock is already set by Set")
	}
...
func (mmSetStatus *RepositoryMock) SetStatus(ctx context.Context, orderID int64, status ordermodels.Status) (err error) {
	...
	if mmSetStatus.SetStatusMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmSetStatus.t.Errorf("RepositoryMock.SetStatus got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.orderID != nil && !minimock.Equal(*mm_want_ptrs.orderID, mm_got.orderID) {
				mmSetStatus.t.Errorf("RepositoryMock.SetStatus got unexpected parameter orderID, want: %#v, got: %#v%s\n", *mm_want_ptrs.orderID, mm_got.orderID, minimock.Diff(*mm_want_ptrs.orderID, mm_got.orderID))
			}

			if mm_want_ptrs.status != nil && !minimock.Equal(*mm_want_ptrs.status, mm_got.status) {
				mmSetStatus.t.Errorf("RepositoryMock.SetStatus got unexpected parameter status, want: %#v, got: %#v%s\n", *mm_want_ptrs.status, mm_got.status, minimock.Diff(*mm_want_ptrs.status, mm_got.status))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSetStatus.t.Errorf("RepositoryMock.SetStatus got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockSetStatusInspect() {
	for _, e := range m.SetStatusMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.SetStatus with params: %#v", *e.params)
		}
	}
	...
	if m.SetStatusMock.defaultExpectation != nil && afterSetStatusCounter < 1 {
		if m.SetStatusMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.SetStatus")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.SetStatus with params: %#v", *m.SetStatusMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.SetStatusMock.invocationsDone() && afterSetStatusCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.SetStatus but found %d calls",
