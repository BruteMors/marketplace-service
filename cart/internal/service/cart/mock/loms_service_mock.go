...
//go:generate minimock -i github.com/BruteMors/marketplace-service/cart/internal/service/cart.LomsService -o loms_service_mock.go -n LomsServiceMock -p mock
...
type LomsServiceMock struct {
	...
	funcOrderCreate          func(ctx context.Context, order lomsserviceModels.OrderCreate) (orderID int64, err error)
	inspectFuncOrderCreate   func(ctx context.Context, order lomsserviceModels.OrderCreate)
	afterOrderCreateCounter  uint64
	beforeOrderCreateCounter uint64
	OrderCreateMock          mLomsServiceMockOrderCreate

	funcStocksInfo          func(ctx context.Context, sku uint32) (count uint64, err error)
...
type LomsServiceMockOrderCreateParams struct {
	ctx   context.Context
	order lomsserviceModels.OrderCreate
}
...
func (mmOrderCreate *mLomsServiceMockOrderCreate) Expect(ctx context.Context, order lomsserviceModels.OrderCreate) *mLomsServiceMockOrderCreate {
...
func (mmOrderCreate *mLomsServiceMockOrderCreate) ExpectOrderParam2(order lomsserviceModels.OrderCreate) *mLomsServiceMockOrderCreate {
	if mmOrderCreate.mock.funcOrderCreate != nil {
		mmOrderCreate.mock.t.Fatalf("LomsServiceMock.OrderCreate mock is already set by Set")
	}
...
func (mmOrderCreate *mLomsServiceMockOrderCreate) Inspect(f func(ctx context.Context, order lomsserviceModels.OrderCreate)) *mLomsServiceMockOrderCreate {
...
func (mmOrderCreate *mLomsServiceMockOrderCreate) Return(orderID int64, err error) *LomsServiceMock {
	if mmOrderCreate.mock.funcOrderCreate != nil {
		mmOrderCreate.mock.t.Fatalf("LomsServiceMock.OrderCreate mock is already set by Set")
	}
	...
	mmOrderCreate.defaultExpectation.results = &LomsServiceMockOrderCreateResults{orderID, err}
	return mmOrderCreate.mock
}

// Set uses given function f to mock the LomsService.OrderCreate method
func (mmOrderCreate *mLomsServiceMockOrderCreate) Set(f func(ctx context.Context, order lomsserviceModels.OrderCreate) (orderID int64, err error)) *LomsServiceMock {
	if mmOrderCreate.defaultExpectation != nil {
...
// Then helper
func (mmOrderCreate *mLomsServiceMockOrderCreate) When(ctx context.Context, order lomsserviceModels.OrderCreate) *LomsServiceMockOrderCreateExpectation {
	if mmOrderCreate.mock.funcOrderCreate != nil {
		mmOrderCreate.mock.t.Fatalf("LomsServiceMock.OrderCreate mock is already set by Set")
	}
...
func (e *LomsServiceMockOrderCreateExpectation) Then(orderID int64, err error) *LomsServiceMock {
	e.results = &LomsServiceMockOrderCreateResults{orderID, err}
	return e.mock
}
...
func (mmOrderCreate *LomsServiceMock) OrderCreate(ctx context.Context, order lomsserviceModels.OrderCreate) (orderID int64, err error) {
	...
	if mmOrderCreate.OrderCreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.order != nil && !minimock.Equal(*mm_want_ptrs.order, mm_got.order) {
				mmOrderCreate.t.Errorf("LomsServiceMock.OrderCreate got unexpected parameter order, want: %#v, got: %#v%s\n", *mm_want_ptrs.order, mm_got.order, minimock.Diff(*mm_want_ptrs.order, mm_got.order))
			}
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) Expect(ctx context.Context, sku uint32) *mLomsServiceMockStocksInfo {
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) ExpectSkuParam2(sku uint32) *mLomsServiceMockStocksInfo {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsServiceMock.StocksInfo mock is already set by Set")
	}
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) Inspect(f func(ctx context.Context, sku uint32)) *mLomsServiceMockStocksInfo {
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) Return(count uint64, err error) *LomsServiceMock {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsServiceMock.StocksInfo mock is already set by Set")
	}
	...
	mmStocksInfo.defaultExpectation.results = &LomsServiceMockStocksInfoResults{count, err}
	return mmStocksInfo.mock
}

// Set uses given function f to mock the LomsService.StocksInfo method
func (mmStocksInfo *mLomsServiceMockStocksInfo) Set(f func(ctx context.Context, sku uint32) (count uint64, err error)) *LomsServiceMock {
	if mmStocksInfo.defaultExpectation != nil {
...
// Then helper
func (mmStocksInfo *mLomsServiceMockStocksInfo) When(ctx context.Context, sku uint32) *LomsServiceMockStocksInfoExpectation {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsServiceMock.StocksInfo mock is already set by Set")
	}
...
func (e *LomsServiceMockStocksInfoExpectation) Then(count uint64, err error) *LomsServiceMock {
	e.results = &LomsServiceMockStocksInfoResults{count, err}
	return e.mock
}
...
func (mmStocksInfo *LomsServiceMock) StocksInfo(ctx context.Context, sku uint32) (count uint64, err error) {
